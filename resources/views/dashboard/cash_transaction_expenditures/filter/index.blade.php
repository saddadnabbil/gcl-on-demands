@extends('dashboard.layouts.main', ['title' => 'Filter Pengeluaran', 'page_heading' => 'Filter Pengeluaran'])
...
@if (!Auth::guest())
	@push('js')
	@include('cash_transaction_expenditures.filter.script')
	@endpush
@else
	@push('js')
	@include('cash_transaction_expenditures.filter.script-guest')
	@endpush
@endif