@extends('dashboard.layouts.main', ['title' => 'Pengeluaran', 'page_heading' => 'Data Pengeluaran'])
	...
	<div class="col card px-3 py-3">
		...
		<div class="d-flex justify-content-end pb-3">
			<div class="btn-group d-gap gap-2">
				...
				<a href="{{ route('cash-transaction-expenditures.index.history') }}" class="btn btn-secondary">
					<span class="badge">{{ $cashTransactionExpendituresTrashedCount }}</span> Histori Data Kas
				</a>
...
@push('modal')
@include('cash_transaction_expenditures.modal.create')
@include('cash_transaction_expenditures.modal.show')
@include('cash_transaction_expenditures.modal.edit')

@include('cash_transaction_expenditures.modal.look-more' )
@endpush

@if(!Auth::guest())
	@push('js')
	@include('cash_transaction_expenditures.script')
	@endpush
@else
	@push('js')
	@include('cash_transaction_expenditures.script-guest')
	@endpush
@endif