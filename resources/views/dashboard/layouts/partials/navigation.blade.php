<div class="sidebar-header">
	<div class="d-flex justify-content-between">
		<div class="logo">
			<a href="@if (!Auth::guest()) {{ route('events-webinars') }} @else {{ route('dashboard.guest') }}  @endif">{{ config('app.name') }}</a>
		</div>
		<div class="toggler">
		...
		<li class="sidebar-item {{ request()->is('dashboard*') ? 'active' : '' }}">
			...
			<ul class="submenu @if(request()->routeIs('cash-transactions.*')) active @else @endif ">
				<li class="submenu-item {{ request()->routeIs('cash-transactions.index') ? 'active' : '' }}">
					<a href="@if (!Auth::guest()) /admin/cash-transactions @else /cash-transactions @endif">Events</a>
				</li>
				<li class="submenu-item {{ request()->routeIs('cash-transactions.filter') ? 'active' : '' }}">
					<a href="@if (!Auth::guest()) /admin/cash-transactions/filter @else /cash-transactions/filter @endif">Webinars</a>
				</li>
			</ul>
		</li>
