			...
			<div class="modal-body">
				...
				<div class="row">
					<div class="col-sm-12 col-md-12 col-lg-4">
						<div class="mb-3">
							<label for="student_identification_number" class="form-label">NOMOR ID</label>
				...
				<div class="row">
					<div class="col-lg-6 col-md-6">
						<div class="mb-3">
							<label for="school_class_id" class="form-label">Blok Rumah</label>
							<input type="text" class="form-control" id="school_class_id" disabled>
						</div>
					</div>
					<div class="col-lg-6 col-md-6">
						<div class="mb-3">
							<label for="school_major_id" class="form-label">RT</label>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12">
						<label for="school_year_start" class="form-label">Periode</label>
