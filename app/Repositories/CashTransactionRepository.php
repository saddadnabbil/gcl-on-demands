...
{
    private $model, $students, $startOfMonth, $endOfMonth;
    ...
    public function sumAmount(string $status = null, string $year = null, string $month = null): Int
    {
        $model = $this->model->select('date', 'amount')->sum('amount');
    ...
    public function results(): array
    {
        return [
            'students' => [
                'notPaidThisMonth' => $this->getStudentWhoNotPaidThisMonth(limit: null, order: 'name'),
                'notPaidThisMonthLimit' => $this->getStudentWhoNotPaidThisMonth(limit: 6, order: 'name'),
            ],
            'studentCountWho' => [
                'paidThisMonth' => $this->countStudentWhoPaidThisMonth(),
                'notPaidThisMonth' => $this->countStudentWhoNotPaidThisMonth(),
            ],
            'totals' => [
