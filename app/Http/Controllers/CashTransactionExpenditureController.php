...
{
    private $cashTransactionExpenditureRepository, $startOfMonth, $endOfMonth;
    ...
    public function index(): View|JsonResponse
    {
        ...
        return view('dashboard.cash_transaction_expenditures.index', [
            // 'students' => $students,
            'data' => $this->cashTransactionExpenditureRepository->results(),
            'cashTransactionExpenditures' => $cashTransactionExpenditures,
